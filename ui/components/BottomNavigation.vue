  ...
  <nav class="fixed bottom-0 left-0 right-0 bg-white shadow-lg border-t border-gray-200 z-50">
    <div class="flex justify-around items-center py-2">
      <NuxtLink
        ...
        :class="$route.path === '/dashboard' ? 'text-primary-300' : 'text-gray-500'"
      >
      ...
      <NuxtLink
        to="/recipe"
        class="flex flex-col items-center justify-center p-2 text-xs font-medium"
        :class="$route.path === '/recipe' ? 'text-primary-300' : 'text-gray-500'"
      >
        <svg class="w-6 h-6 mb-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <NuxtLink
        ...
        :class="$route.path === '/mypage' ? 'text-primary-300' : 'text-gray-500'"
      >
        <svg class="w-6 h-6 mb-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
